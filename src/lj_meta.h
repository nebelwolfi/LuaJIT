...
LJ_FUNCA double bit_helper_and(double a, double b);
LJ_FUNCA double bit_helper_or (double a, double b);
LJ_FUNCA double bit_helper_xor(double a, double b);
LJ_FUNCA double bit_helper_shl(double a, double b);
LJ_FUNCA double bit_helper_shr(double a, double b);
