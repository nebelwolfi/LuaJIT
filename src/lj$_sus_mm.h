...
typedef HCUSTOMMODULE (*CustomLoadLibraryFunc)(void *, LPCSTR);
typedef HCUSTOMMODULE (*CustomGetModuleHandleFunc)(void *, LPCSTR);
typedef void* (*CustomGetProcAddressFunc)(void *, HCUSTOMMODULE, LPCSTR);
typedef void (*CustomFreeLibraryFunc)(void *, HCUSTOMMODULE);
