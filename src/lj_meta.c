...
double bit_helper_and(double a, double b) {
  //printf("bit_helper_and(%x, %x) => %x\n", (unsigned long long)a, (unsigned long long)b, (unsigned long long)a & (unsigned long long)b);
  return (unsigned long long)a & (unsigned long long)b;
}

double bit_helper_or(double a, double b) {
  return (unsigned long long)a | (unsigned long long)b;
}

double bit_helper_xor(double a, double b) {
  return (unsigned long long)a ^ (unsigned long long)b;
}

double bit_helper_shl(double a, double b) {
  return (unsigned long long)a << (unsigned long long)b;
}

double bit_helper_shr(double a, double b) {
  return (unsigned long long)a >> (unsigned long long)b;
}