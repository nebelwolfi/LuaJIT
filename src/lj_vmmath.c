...
double lj_vm_foldarith(double x, double y, int op)
{
  ...
  case IR_BNOT - IR_ADD: return (double)(~(int64_t)x); break;
  case IR_BSWAP - IR_ADD: return (double)lj_bswap((int64_t)x); break;
  case IR_BAND - IR_ADD: return (double)((unsigned long long)x & (unsigned long long)y); break;
  case IR_BOR - IR_ADD: return (double)((unsigned long long)x | (unsigned long long)y); break;
  case IR_BXOR - IR_ADD: return (double)((unsigned long long)x ^ (unsigned long long)y); break;
  case IR_BSHL - IR_ADD: return (double)((unsigned long long)x << (unsigned long long)y); break;
  case IR_BSHR - IR_ADD: return (double)((unsigned long long)x >> (unsigned long long)y); break;
  case IR_BBNOT - IR_ADD: return (double)(~(int64_t)x); break;
  case IR_BBAND - IR_ADD: return (double)((unsigned long long)x & (unsigned long long)y); break;
  case IR_BBOR - IR_ADD: return (double)((unsigned long long)x | (unsigned long long)y); break;
  case IR_BBXOR - IR_ADD: return (double)((unsigned long long)x ^ (unsigned long long)y); break;
  case IR_BBSHL - IR_ADD: return (double)((unsigned long long)x << (unsigned long long)y); break;
  case IR_BBSHR - IR_ADD: return (double)((unsigned long long)x >> (unsigned long long)y); break;
#if LJ_HASJIT
